...
namespace SharpStatistics.EasyERAddIn.Functions.Controls
{
    ...
    /// </summary>
    public partial class SharpMultiVariable : UserControl, IFunctionControl, INotifyPropertyChanged
    {
        ...
        public SharpMultiVariable(string label, string variable, bool isProperty)
        {
            InitializeComponent();
